    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (opcion) {
            ...
            default:
                ...
                if (Numerodeventafacturaventa == null) {
                    Numerodeventafacturaventa = "00000001";
                    request.setAttribute("Numerodeventafacturaventa", Numerodeventafacturaventa);

                } else {
                    int incrementar = Integer.parseInt(Numerodeventafacturaventa);
                    ObtenerNumeroDeFactura gs = new ObtenerNumeroDeFactura();
                    Numerodeventafacturaventa = gs.NumeroDeFactura(incrementar);
                    request.setAttribute("Numerodeventafacturaventa", Numerodeventafacturaventa);
