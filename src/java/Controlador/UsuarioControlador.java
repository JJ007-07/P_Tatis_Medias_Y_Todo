...
import Controlador.EnvioCorreo;
...
public class UsuarioControlador extends HttpServlet {
    ...
    private String asunto = "Hola", mensaje = "Mucho gusto";

    @Override
    public void init() {
        ServletContext context = getServletContext();
        server = context.getInitParameter("host");
        port = context.getInitParameter("puerto");
        mail = context.getInitParameter("usuario");
        pass = context.getInitParameter("clave");
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        asunto = "Registro Exitosamente a  Sistematic";
        mensaje = "Bienvenido a sistematic. \nSu clave es " + PasswordUsuario;
        ...
        switch (opcion) {
            ...
            case 1: //Agregar Registro
                if (usuDAO.agregarRegistro()) {
                    ...
                    try {
                        EnvioCorreo.envioCorreo(server, port, mail, pass, NombreUsuario, asunto, mensaje);
            ...
            case 4://Inicio de sesion
                if (usuDAO.iniciarSesion(NombreUsuario, PasswordUsuario)) {
                    ...
                    request.setAttribute("mensajeExito", "<center><h2>Datos de ingreso incorrectos</h2></center><br>");
