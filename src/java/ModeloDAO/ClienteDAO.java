...
public class ClienteDAO extends ConexionDB implements Crud{
    ...
    public boolean agregarRegistro() {
        try {
              sql = "INSERT INTO cliente(NombreCliente,ApellidoCliente,TipoDocCliente,NumeroDocCliente,TelefonoCliente,DireccionCliente,CorreoCliente,EstadoCliente) VALUES (?,?,?,?,?,?,?,?);";
