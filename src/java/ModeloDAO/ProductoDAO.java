...
public class ProductoDAO extends ConexionDB implements Crud{
  ...
  private String IdProducto="",CodigoDeBarrasProducto="",ReferenciaProducto="",DescripcionProducto="",StockProducto="",PrecioCosto="",PrecioUnitario="",EstadoProducto="",IdCategoriaFK="",IdEmpresaProveedoraFK="";
  ...
  public ProductoDAO(){
    ...
    public ProductoDAO(ProductoVO proVO) {
        ...
        try {
            ...
            PrecioCosto=proVO.getPrecioCosto();
    ...
    public boolean agregarRegistro() {
        try {
            sql="insert into Producto (CodigoDeBarrasProducto,ReferenciaProducto,DescripcionProducto,StockProducto,PrecioCosto,PrecioUnitario,EstadoProducto,IdCategoriaFK,IdEmpresaProveedoraFK) values(?,?,?,?,?,?,?,?,?)";
            ...
            puente.setString(5,PrecioCosto);
    ...
    public boolean actualizarRegistro() {
        try {
            sql="update producto SET CodigoDeBarrasProducto=?,ReferenciaProducto=?,"+ "DescripcionProducto=?,StockProducto=?," +"PrecioCosto=?,PrecioUnitario=?,EstadoProducto=? WHERE IdProducto=?";
            puente = conexion.prepareCall(sql);
            puente.setString(1,CodigoDeBarrasProducto);
            puente.setString(2,ReferenciaProducto );
            puente.setString(3,DescripcionProducto);
    ...
    public boolean eliminarRegistro() {
     ...
     public boolean consultarProducto(String CodigoDeBarrasProducto,String ReferenciaProducto ,String DescripcionProducto ,String StockProducto,String PrecioCosto,String PrecioUnitario,String EstadoProducto,String IdCategoriaFK,String IdEmpresaProveedoraFK)
{
        ...
        try {
            ...
            puente.setString(6,PrecioCosto);
       ...
       ProductoVO proVO = null;
         try {
            ...
            if(mensajero.next()) {
                ...
                proVO= new ProductoVO(mensajero.getString(1),mensajero.getString(2),mensajero.getString(3),mensajero.getString(4),mensajero.getString(5), mensajero.getString(6), mensajero.getString(7),mensajero.getString(8),mensajero.getString(9), mensajero.getString(10));
     ...
     public int actualizarstock (String CodigoDeBarrasProducto, String StockProducto ){
     
         try {
             sql="update producto set StockProducto=? where CodigoDeBarrasProducto=?";
             conexion =this.obtenerConexion();
              puente = conexion.prepareStatement(sql);
              puente.setString(1,StockProducto);
