...
public class EmpleadoDAO extends ConexionDB implements Crud {
    ...
    public boolean agregarRegistro() {
        try {
            sql = "INSERT INTO Empleado(NombreEmpleado,ApellidoEmpleado,TipoDocEmpleado,NumeroDocEmpleado,TelefonoCelularEmpleado,DireccionEmpleado,CorreoEmpleado,EstadoEmpleado,IdUsuarioFK) VALUES (?,?,?,?,?,?,?,?,?);";
    ...
    public EmpleadoVO consultarCodigo(String IdEmpleado) {
