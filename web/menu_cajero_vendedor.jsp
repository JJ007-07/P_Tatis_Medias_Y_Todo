...
<%
    ...
    rs2 = smt2.executeQuery("select FechaventaMostrador, FormaventaMostrador, C.NombreCliente, C.ApellidoCliente from ventamostrador inner join cliente as C on NumDocClienteFK = C.NumeroDocCliente");
    rs3 = smt3.executeQuery("select FechaventaMostrador, FormaventaMostrador, C.NombreCliente, C.ApellidoCliente from ventamostrador inner join cliente as C on NumDocClienteFK = C.NumeroDocCliente");
    rs4 = smt4.executeQuery("select FechaventaMostrador, FormaventaMostrador, C.NombreCliente, C.ApellidoCliente from ventamostrador inner join cliente as C on NumDocClienteFK = C.NumeroDocCliente");
    rs5 = smt5.executeQuery("select FechaventaMostrador, FormaventaMostrador, C.NombreCliente, C.ApellidoCliente from ventamostrador inner join cliente as C on NumDocClienteFK = C.NumeroDocCliente");
%>
<!DOCTYPE html>
<html lang="es">
    <head>
