                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="Venta" method="post">
                            ...
                            <div class="col-md-8 d-flex form-group">
                                <input type="number" value="1" name="texcantidad" class="form-control" required placeholder="Cantidad">
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control col-md-4" name="textformaventa" required>
                                ...
                                <div class="card-footer d-flex">
                                    <div class="col-md-8 text-center">
                                        ...
                                        <input type="submit" class="btn btn-danger" value="Nueva Venta" class="btn btn-outline-primary col text-center">
