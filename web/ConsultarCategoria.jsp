        ...
        <div class="row">
            <div class="col">              
                ...
                <img src="https://reymon.com.co/wp-content/uploads/2022/04/DSC3663-1350x900.jpg" class="w-100" style="border-top-left-radius: .3rem; border-top-right-radius: .3rem;" alt="Sample photo">
                    ...
                    <div class="p-3 mb-2 bg-primary bg-gradient fw-bold text-white">Consultar Información de categoria</div>
                    <form class="row g-3 needs-validation" method="post" action="Categoria"  novalidate>
                        ...
                        <label class="form-label" for="form3Example1q">Id De La Categoría</label>
                         <input max="100000" type="number" name="txtid" class="form-control"  value="" required >
                    ...
                    <div><center>
                            <button type="submit" class="btn btn-success btn-lg mb-1"><a href="DatosCategoria.jsp" style="color: #FFFFFF; text-decoration: none;">Consulta General</a></button></center>
