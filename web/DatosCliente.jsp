...
<html>
    <head>
        ...
        <title>Cliente General</title>
    </head>
  <body>
      <a href="ConsultarCliente.jsp"> <img src="IMG/backward_arrow_4020.png" alt="" width="50px"/></a> 
                    ...
                    <tbody >
                        ...
                        <tr>
                            <td><%= rs.getInt("IdCliente")%></td>
                             ...
                             <td><%= rs.getString("ApellidoCliente")%></td>
                            <td><%= rs.getString("NumeroDocCliente")%></td>
                            <td><%= rs.getString("EstadoCliente")%></td>
<td>
