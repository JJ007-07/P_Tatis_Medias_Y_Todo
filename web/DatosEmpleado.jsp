...
%>
   <body>
       ...
       <a href="ConsultarEmpleado.jsp"> <img src="IMG/backward_arrow_4020.png" alt="" width="50px"/></a>    
       ...
       <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                             ...
                             <td ><%= rs.getInt("IdEmpleado")%></td>
                             <td ><%= rs.getString("NombreEmpleado")%></td>
                             <td ><%= rs.getString("ApellidoEmpleado")%></td>
