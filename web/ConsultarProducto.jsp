        ...
        <div class="row">
            <div class="col">              
                <div class="shadow-lg p-3 mb-5 mt-4 bg-body rounded">
                    ...
                    <div class="p-3 mb-2 bg-primary bg-gradient fw-bold text-white">Consultar Información de Producto</div>
                    <form class="row g-3 needs-validation" method="post" action="Producto"  novalidate>
                        ...
                        <input  type="number" name="txtcodigoB" class="form-control" value="" required>
                       ...
                       <div>   
                                        <div class="form-outline mb-4">
                                           ...
                                           <button class="btn btn-primary btn-lg" style="margin-bottom: 4px;" style="color: #FFFFFF; text-decoration: none;" type="submit" onclick="return confirm('¿Estas seguro de consultar este producto?')"  >Consultar</button>  
                                           
                        </center> </form>
                    <div><center>
                            <button type="submit" class="btn btn-success btn-lg mb-1"><a href="DatosProducto.jsp" style="color: #FFFFFF; text-decoration: none;">Consulta General</a></button></center>
