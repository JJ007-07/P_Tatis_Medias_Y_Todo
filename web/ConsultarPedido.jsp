                ...
                <div class="row d-flex justify-content-center align-items-center h-100">
                    <div class="col-lg-8 col-xl-6">
                        <div class="card rounded-3">
                            <img src="https://creatuaplicacion.com/wp-content/uploads/2019/02/ver-pedidos.png" class="w-100" style="border-top-left-radius: .3rem; border-top-right-radius: .3rem;" alt="Sample photo">
                            <div class="card-body p-4 p-md-5">
                                <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Consultar Información De Los Pedidos</h3>
                                <form method="post" action="Pedido">
                                    <div class="form-outline mb-4">
                                          <label class="form-label" for="form3Example1q">Id pedido</label>
                                        <input  type="number" name="txtPedido" class="form-control" required>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="container">               
                                                                <table class="table table-bordered"  id="tablaDatos">
                                                                    <thead>
                                                                        <tr>
                                                                            <th class="text-center">ID DE PEDIDOS</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody id="tbodys">
                                                                        ...
                                                                        <tr>
                                                                            <td class="text-center"><%= rs.getString("Idpedido")%></td>
