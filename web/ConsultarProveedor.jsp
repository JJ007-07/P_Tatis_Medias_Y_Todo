    ...
    <div class="container">
        <div class="row">
            ...
            alt="Sample photo">
                    ...
                    <div class="p-3 mb-2 bg-primary bg-gradient fw-bold text-white">Consultar Información del Proveedor</div>
                    <form class="row g-3 needs-validation" method="post" action="EmpresaProveedora"  novalidate>
                        ...
                        <input max="100000" type="text" name="txtNombreC" class="form-control"  value="" required >
                    ...
                    <div><center>
                            <button type="submit" class="btn btn-success btn-lg mb-1"><a href="DatosProveedor.jsp" style="color: #FFFFFF; text-decoration: none;">Consulta General</a></button></center>
