        ...
        <div class="row">
            <div class="col">              
                ...
                alt="Sample photo">
                    ...
                    <div class="p-3 mb-2 bg-primary bg-gradient fw-bold text-white">Consultar Usuario</div>
                    <form class="row g-3 needs-validation" method="post" action="Usuario"  novalidate>
                        <center>
    
                        
                        <div class="col-md-4">
                        <label class="form-label" for="form3Example1q">NOMBRE DEL USUARIO</label>
                        <input type="text" name="textUsuario" class="form-control" value="" required >
                    ...
                    <div><center>
                            <button type="submit" class="btn btn-success btn-lg mb-1"><a href="DatosUsuario.jsp" style="color: #FFFFFF; text-decoration: none;">Consulta General</a></button></center>
